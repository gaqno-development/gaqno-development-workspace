...
**Critério de conclusão:** Decisão documentada em BACKEND.md.
...
**Critério de conclusão:** Convenção em FRONTEND.md; principais hooks conformes.
...
| Item                                           | Status                                                          |
| ---------------------------------------------- | --------------------------------------------------------------- |
| Documentar convenção snake_case vs camelCase   | ✅ [API-CONTRACTS-CONVENTION.md](./API-CONTRACTS-CONVENTION.md) |
...
- [BACKEND.md](./BACKEND.md) — seção Architecture Audit
- [FRONTEND.md](./FRONTEND.md) — seção Architecture Audit
