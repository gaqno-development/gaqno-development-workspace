...
|---------|-------|--------|-------|-------|-------|--------|
| **gaqno-saas-ui** | 94.42 | 86.24 | 87.44 | 94.83 | 193 | ✅ Passes 80% |
| **gaqno-erp-service** | 95 | 96.42 | 80 | 96.85 | 54 | ✅ Passes 80% |
| **gaqno-crm-service** | 98.08 | 93.10 | 91.39 | 98.59 | 151 | ✅ Passes 80% |
| **gaqno-saas-service** | 86.23 | 85 | 98.14 | 88.51 | 86 | ✅ Passes 80% |
...
**9 of 11 backend services pass 80% on all metrics.** The remaining 2 (RPG, Omnichannel) have complex AI, WebSocket, and messaging integrations that need more unit tests.

---

## Services Passing 80% (9/11)
...
### gaqno-saas-service ✅
86.23/85/98.14/88.51. 86 tests. Tests for: costs (controller+service), codemap (controller+service), websocket gateway, health, ai-models (controller+service).
...
## Services Needing More Work (2/11)
...
Run `npm run test:cov` (or `test:coverage`) in each service. 9 services pass 80% thresholds. RPG and Omnichannel need continued test development.
