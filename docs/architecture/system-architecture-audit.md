...
Documentação que operacionaliza este audit:

| Documento                                          | Descrição                                        |
| -------------------------------------------------- | ------------------------------------------------ |
| [refactoring-roadmap.md](./refactoring-roadmap.md) | Passos executáveis por prioridade                |
| [contracts-and-types.md](./contracts-and-types.md) | snake_case vs camelCase, onde transformar        |
| [../guides/backend.md](../guides/backend.md)       | Seção Architecture Audit, convenção de contratos |
| [../guides/frontend.md](../guides/frontend.md)     | Seção Architecture Audit, padrões obrigatórios   |
