...
| "gaqno-mastra integration / certify" | [`references/integration-certification.md`](references/integration-certification.md) | Recorded verification for this monorepo        |
...
- **gaqno-mastra certification**: [`references/integration-certification.md`](references/integration-certification.md) — Cursor copy also under `.cursor/skills/mastra/references/`
