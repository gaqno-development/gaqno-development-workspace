...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 w-full flex-1 flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden gap-4",
        className,
      )}
      {...props}
    />
...
>(({ className, isActive, ...props }, ref) => (
  <li
    ...
    className={cn(
      ...
      isActive &&
        "before:absolute before:left-0 before:top-2 before:bottom-2 before:w-1 before:rounded-r before:bg-primary before:transition-all before:duration-150 before:ease-out before:z-10",
      className,
    )}
    {...props}
  />
