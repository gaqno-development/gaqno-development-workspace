...
6. **Write design doc** — save to `docs/superpowers/specs/YYYY-MM-DD-<name>-design.md` and commit
...
- Write the validated design (spec) to `docs/superpowers/specs/YYYY-MM-DD-<name>-design.md`
